...
import sys
import numpy as np
import writeBedGraph_fractionByNH as writeBedGraph  # This should be made directly into a bigWig
...
def get_optional_args():
    ...
    optional.add_argument('--maxMultipleAlignSite',
                          help='Reads mapped to more than this number of sites will be discarded, and '
                               'number of mapped sites is determined by NH tag. A value of 0 means no '
                               'limitation for mapped site number. (Default: %(default)s)',
                          default=5,
                          type=int)
...
def main(args=None):
    ...
    if args.MNase:
        ...
        wr = CenterFragment([args.bam],
                            ...
                            verbose=args.verbose,
                            maxMultipleAlignSite=args.maxMultipleAlignSite
                            )
