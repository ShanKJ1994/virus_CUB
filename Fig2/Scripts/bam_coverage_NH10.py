...
def main(bam_path, output_prefix, fixed_offset,
    ...
    for read in bamfile:
        ...
        if nh_tag > 10 or read.is_supplementary:
            continue
        ...
        if read.is_reverse:
            cov_minus[ read.get_reference_positions()[-(offset + 1)] ] += 1/nh_tag
        else:
            cov_plus[ read.get_reference_positions()[offset] ] += 1/nh_tag
...
if __name__ == '__main__':
    ...
    parser.add_argument('bam',
                        metavar='bam',
                        help='path to input bam [header necessary]')
