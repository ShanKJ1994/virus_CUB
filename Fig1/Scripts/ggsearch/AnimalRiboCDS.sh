...
perl /gpfs2/shankj/CodonUsage2/Test/ggsearch/ribosomalCDS_seq.pl ${id%.pep.all.fa}.potentialRP.fasta /gpfs2/shankj/CodonUsage2/Ensembl/CDS/${id%.pep.all.fa}.cds.all.fa.gz > /gpfs2/shankj/CodonUsage2/Ensembl/ribosomalProtein/animals/${id%.pep.all.fa}.ribomalCDS.fas
perl /gpfs2/shankj/CodonUsage2/bin/CodonUsage.pl /gpfs2/shankj/CodonUsage2/Ensembl/ribosomalProtein/animals/${id%.pep.all.fa}.ribomalCDS.fas >  /gpfs2/shankj/CodonUsage2/Ensembl/ribosomalProtein/animals/${id%.pep.all.fa}.ribomalCDS.CUB.txt
