...
Homo=fread("./Homo_Euclidean_Distance.txt")
Homo$Type="human virus"
nonHomo=fread("./nonHomoMammal_Euclidean_Distance.txt")
nonHomo$Type="non-human virus"

head(Homo)
library(gghalves)             
ggplot(rbind(Homo,nonHomo),
