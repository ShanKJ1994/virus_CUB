process_file() {
  ...
  prefix="/gpfs2/gaopx/CodonOptimum/XBB.1.5_S_RiboSeq/alignment_plasmid_dedup"
...
ls /gpfs2/gaopx/CodonOptimum/XBB.1.5_S_RiboSeq/alignment_plasmid/*_Aligned.sortedByCoord.out.bam | xargs -P 8 -I {} bash -c 'process_file "$@"' _ {}
