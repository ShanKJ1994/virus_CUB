process_file() {
  ...
  prefix="/gpfs2/gaopx/CodonOptimum/XBB.1.5_S_RiboSeq/alignment_RIBO_Hs_dedup"
...
ls /gpfs2/gaopx/CodonOptimum/XBB.1.5_S_RiboSeq/alignment_RIBO_Hs/*_Aligned.sortedByCoord.out.bam | xargs -P 16 -I {} bash -c 'process_file "$@"' _ {}
